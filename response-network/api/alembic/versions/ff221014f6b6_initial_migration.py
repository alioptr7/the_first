...
Revision ID: ff221014f6b6
Revises: 
Create Date: 2025-11-03 20:49:34.129039
...
def upgrade() -> None:
    ...
    sa.Column('is_user_specific', sa.Boolean(), nullable=False),
    ...
    sa.Column('user_id', sa.UUID(), nullable=False),
    sa.Column('request_type_id', sa.UUID(), nullable=False),
    sa.Column('allowed_indices', postgresql.JSONB(astext_type=sa.Text()), nullable=False, comment='لیست ایندکس\u200cهایی که کاربر به آنها دسترسی دارد'),
